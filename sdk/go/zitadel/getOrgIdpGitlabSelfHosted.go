...
//			_, err := zitadel.GetOrgIdpGitlabSelfHosted(ctx, &zitadel.LookupOrgIdpGitlabSelfHostedArgs{
...
func LookupOrgIdpGitlabSelfHostedOutput(ctx *pulumi.Context, args LookupOrgIdpGitlabSelfHostedOutputArgs, opts ...pulumi.InvokeOption) LookupOrgIdpGitlabSelfHostedResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrgIdpGitlabSelfHostedResultOutput, error) {
			args := v.(LookupOrgIdpGitlabSelfHostedArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getOrgIdpGitlabSelfHosted:getOrgIdpGitlabSelfHosted", args, LookupOrgIdpGitlabSelfHostedResultOutput{}, options).(LookupOrgIdpGitlabSelfHostedResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o LookupOrgIdpGitlabSelfHostedResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOrgIdpGitlabSelfHostedResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
