...
//			_, err := zitadel.GetIdpLdap(ctx, &zitadel.LookupIdpLdapArgs{
...
// Root CA for self-signed certificates for TLS connections to LDAP servers. It is intended to be filled with the contents of a .pem file.
func (o LookupIdpLdapResultOutput) RootCa() pulumi.StringOutput {
	return o.ApplyT(func(v LookupIdpLdapResult) string { return v.RootCa }).(pulumi.StringOutput)
}
