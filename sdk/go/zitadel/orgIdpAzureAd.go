...
// A non-reversible hash of the write-only client_secret, used to detect when the secret changes. It does not contain the secret itself.
func (o OrgIdpAzureAdOutput) ClientSecretHash() pulumi.StringOutput {
	return o.ApplyT(func(v *OrgIdpAzureAd) pulumi.StringOutput { return v.ClientSecretHash }).(pulumi.StringOutput)
}
