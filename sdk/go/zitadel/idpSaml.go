...
// If enabled, ZITADEL will send a logout request to the identity provider when the user terminates the session in ZITADEL. Be sure to provide a SLO endpoint as part of the metadata.
func (o IdpSamlOutput) FederatedLogoutEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.BoolPtrOutput { return v.FederatedLogoutEnabled }).(pulumi.BoolPtrOutput)
}
...
// URL to the metadata of the SAML identity provider
func (o IdpSamlOutput) MetadataUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.StringPtrOutput { return v.MetadataUrl }).(pulumi.StringPtrOutput)
}

// The metadata XML as plain string
func (o IdpSamlOutput) MetadataXml() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.StringPtrOutput { return v.MetadataXml }).(pulumi.StringPtrOutput)
}
...
// The nameid-format requested, supported values: SAML*NAME*ID*FORMAT*UNSPECIFIED, SAML*NAME*ID*FORMAT*EMAIL*ADDRESS, SAML*NAME*ID*FORMAT*PERSISTENT, SAML*NAME*ID*FORMAT_TRANSIENT
func (o IdpSamlOutput) NameIdFormat() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.StringPtrOutput { return v.NameIdFormat }).(pulumi.StringPtrOutput)
}

// Signature Algorithm used to sign SAML requests and responses. Can be used only if `withSignedRequest` is true., supported values: SAML*SIGNATURE*UNSPECIFIED, SAML*SIGNATURE*RSA*SHA1, SAML*SIGNATURE*RSA*SHA256, SAML*SIGNATURE*RSA_SHA512
func (o IdpSamlOutput) SignatureAlgorithm() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.StringPtrOutput { return v.SignatureAlgorithm }).(pulumi.StringPtrOutput)
}

// Name of the attribute used to map the user in case the nameid-format is `urn:oasis:names:tc:SAML:2.0:nameid-format:transient`.
func (o IdpSamlOutput) TransientMappingAttributeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpSaml) pulumi.StringPtrOutput { return v.TransientMappingAttributeName }).(pulumi.StringPtrOutput)
}
