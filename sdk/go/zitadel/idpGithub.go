...
// A non-reversible hash of the write-only client_secret, used to detect when the secret changes. It does not contain the secret itself.
func (o IdpGithubOutput) ClientSecretHash() pulumi.StringOutput {
	return o.ApplyT(func(v *IdpGithub) pulumi.StringOutput { return v.ClientSecretHash }).(pulumi.StringOutput)
}
