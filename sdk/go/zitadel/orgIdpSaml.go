...
//				Name:                          pulumi.String("My Generic SAML IDP"),
//				Binding:                       pulumi.String("SAML_BINDING_POST"),
//				WithSignedRequest:             pulumi.Bool(true),
//				NameIdFormat:                  pulumi.String("SAML_NAME_ID_FORMAT_EMAIL_ADDRESS"),
//				TransientMappingAttributeName: pulumi.String(""),
//				FederatedLogoutEnabled:        pulumi.Bool(false),
//				SignatureAlgorithm:            pulumi.String("SAML_SIGNATURE_RSA_SHA256"),
...
type OrgIdpSaml struct {
	...
	FederatedLogoutEnabled pulumi.BoolPtrOutput `pulumi:"federatedLogoutEnabled"`
	...
	TransientMappingAttributeName pulumi.StringPtrOutput `pulumi:"transientMappingAttributeName"`
...
type OrgIdpSamlState struct {
	...
	// If enabled, ZITADEL will send a logout request to the identity provider when the user terminates the session in ZITADEL. Be sure to provide a SLO endpoint as part of the metadata.
	FederatedLogoutEnabled pulumi.BoolPtrInput
	// enable if a new account in ZITADEL should be created automatically on login with an external account
	...
	// Name of the attribute used to map the user in case the nameid-format is `urn:oasis:names:tc:SAML:2.0:nameid-format:transient`.
	TransientMappingAttributeName pulumi.StringPtrInput
	// Whether the SAML IDP requires signed requests
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o OrgIdpSamlOutput) AutoLinking() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.AutoLinking }).(pulumi.StringPtrOutput)
}
...
// If enabled, ZITADEL will send a logout request to the identity provider when the user terminates the session in ZITADEL. Be sure to provide a SLO endpoint as part of the metadata.
func (o OrgIdpSamlOutput) FederatedLogoutEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.BoolPtrOutput { return v.FederatedLogoutEnabled }).(pulumi.BoolPtrOutput)
}
...
// URL to the metadata of the SAML identity provider
func (o OrgIdpSamlOutput) MetadataUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.MetadataUrl }).(pulumi.StringPtrOutput)
}

// The metadata XML as plain string
func (o OrgIdpSamlOutput) MetadataXml() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.MetadataXml }).(pulumi.StringPtrOutput)
}
...
// The nameid-format requested, supported values: SAML*NAME*ID*FORMAT*UNSPECIFIED, SAML*NAME*ID*FORMAT*EMAIL*ADDRESS, SAML*NAME*ID*FORMAT*PERSISTENT, SAML*NAME*ID*FORMAT_TRANSIENT
func (o OrgIdpSamlOutput) NameIdFormat() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.NameIdFormat }).(pulumi.StringPtrOutput)
}
...
// Signature Algorithm used to sign SAML requests and responses. Can be used only if `withSignedRequest` is true., supported values: SAML*SIGNATURE*UNSPECIFIED, SAML*SIGNATURE*RSA*SHA1, SAML*SIGNATURE*RSA*SHA256, SAML*SIGNATURE*RSA_SHA512
func (o OrgIdpSamlOutput) SignatureAlgorithm() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.SignatureAlgorithm }).(pulumi.StringPtrOutput)
}

// Name of the attribute used to map the user in case the nameid-format is `urn:oasis:names:tc:SAML:2.0:nameid-format:transient`.
func (o OrgIdpSamlOutput) TransientMappingAttributeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpSaml) pulumi.StringPtrOutput { return v.TransientMappingAttributeName }).(pulumi.StringPtrOutput)
}
