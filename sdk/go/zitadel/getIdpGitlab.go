...
//			_, err := zitadel.GetIdpGitlab(ctx, &zitadel.LookupIdpGitlabArgs{
...
func LookupIdpGitlabOutput(ctx *pulumi.Context, args LookupIdpGitlabOutputArgs, opts ...pulumi.InvokeOption) LookupIdpGitlabResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIdpGitlabResultOutput, error) {
			args := v.(LookupIdpGitlabArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getIdpGitlab:getIdpGitlab", args, LookupIdpGitlabResultOutput{}, options).(LookupIdpGitlabResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o LookupIdpGitlabResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v LookupIdpGitlabResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
