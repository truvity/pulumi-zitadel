...
//			_, err := zitadel.GetApplicationSaml(ctx, &zitadel.LookupApplicationSamlArgs{
...
type LookupApplicationSamlResult struct {
	...
	LoginVersions []GetApplicationSamlLoginVersion `pulumi:"loginVersions"`
...
// Specify the preferred login UI, where the user is redirected to for authentication. If unset, the login UI is chosen by the instance default.
func (o LookupApplicationSamlResultOutput) LoginVersions() GetApplicationSamlLoginVersionArrayOutput {
	return o.ApplyT(func(v LookupApplicationSamlResult) []GetApplicationSamlLoginVersion { return v.LoginVersions }).(GetApplicationSamlLoginVersionArrayOutput)
}
