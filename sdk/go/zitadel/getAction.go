...
//			_default, err := zitadel.GetAction(ctx, &zitadel.LookupActionArgs{
...
func LookupActionOutput(ctx *pulumi.Context, args LookupActionOutputArgs, opts ...pulumi.InvokeOption) LookupActionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupActionResultOutput, error) {
			...
			return ctx.InvokeOutput("zitadel:index/getAction:getAction", args, LookupActionResultOutput{}, options).(LookupActionResultOutput), nil
