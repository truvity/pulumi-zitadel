...
func GetOrgOidcIdpOutput(ctx *pulumi.Context, args GetOrgOidcIdpOutputArgs, opts ...pulumi.InvokeOption) GetOrgOidcIdpResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOrgOidcIdpResultOutput, error) {
			args := v.(GetOrgOidcIdpArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getOrgOidcIdp:getOrgOidcIdp", args, GetOrgOidcIdpResultOutput{}, options).(GetOrgOidcIdpResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o GetOrgOidcIdpResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v GetOrgOidcIdpResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
...
// Defines if the Proof Key for Code Exchange (PKCE) is used for the authorization code flow.
func (o GetOrgOidcIdpResultOutput) UsePkce() pulumi.BoolOutput {
	return o.ApplyT(func(v GetOrgOidcIdpResult) bool { return v.UsePkce }).(pulumi.BoolOutput)
}
