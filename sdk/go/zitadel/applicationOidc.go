...
type ApplicationOidc struct {
	...
	BackChannelLogoutUri pulumi.StringOutput `pulumi:"backChannelLogoutUri"`
	...
	NoneCompliant pulumi.BoolOutput `pulumi:"noneCompliant"`
...
type ApplicationOidcState struct {
	...
	// ZITADEL will use this URI to notify the application about terminated session according to the OIDC Back-Channel Logout
	BackChannelLogoutUri pulumi.StringPtrInput
	// generated ID for this config
	...
	// specifies whether the config is OIDC compliant. A production configuration SHOULD be compliant
	NoneCompliant pulumi.BoolPtrInput
	// ID of the organization. If not provided, the organization of the authenticated user/service account is used.
...
// ZITADEL will use this URI to notify the application about terminated session according to the OIDC Back-Channel Logout
func (o ApplicationOidcOutput) BackChannelLogoutUri() pulumi.StringOutput {
	return o.ApplyT(func(v *ApplicationOidc) pulumi.StringOutput { return v.BackChannelLogoutUri }).(pulumi.StringOutput)
}
...
// Specify the preferred login UI, where the user is redirected to for authentication. If unset, the login UI is chosen by the instance default.
func (o ApplicationOidcOutput) LoginVersion() ApplicationOidcLoginVersionOutput {
	return o.ApplyT(func(v *ApplicationOidc) ApplicationOidcLoginVersionOutput { return v.LoginVersion }).(ApplicationOidcLoginVersionOutput)
}
...
// specifies whether the config is OIDC compliant. A production configuration SHOULD be compliant
func (o ApplicationOidcOutput) NoneCompliant() pulumi.BoolOutput {
	return o.ApplyT(func(v *ApplicationOidc) pulumi.BoolOutput { return v.NoneCompliant }).(pulumi.BoolOutput)
}
