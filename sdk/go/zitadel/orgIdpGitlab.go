...
// A non-reversible hash of the write-only client_secret, used to detect when the secret changes. It does not contain the secret itself.
func (o OrgIdpGitlabOutput) ClientSecretHash() pulumi.StringOutput {
	return o.ApplyT(func(v *OrgIdpGitlab) pulumi.StringOutput { return v.ClientSecretHash }).(pulumi.StringOutput)
}
