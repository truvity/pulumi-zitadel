...
//			_, err := zitadel.GetOrgIdpGithub(ctx, &zitadel.LookupOrgIdpGithubArgs{
...
func LookupOrgIdpGithubOutput(ctx *pulumi.Context, args LookupOrgIdpGithubOutputArgs, opts ...pulumi.InvokeOption) LookupOrgIdpGithubResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrgIdpGithubResultOutput, error) {
			args := v.(LookupOrgIdpGithubArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getOrgIdpGithub:getOrgIdpGithub", args, LookupOrgIdpGithubResultOutput{}, options).(LookupOrgIdpGithubResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o LookupOrgIdpGithubResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOrgIdpGithubResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
