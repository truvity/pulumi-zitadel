...
//			_, err := zitadel.GetOrgIdpLdap(ctx, &zitadel.LookupOrgIdpLdapArgs{
...
func LookupOrgIdpLdapOutput(ctx *pulumi.Context, args LookupOrgIdpLdapOutputArgs, opts ...pulumi.InvokeOption) LookupOrgIdpLdapResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupOrgIdpLdapResultOutput, error) {
			args := v.(LookupOrgIdpLdapArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getOrgIdpLdap:getOrgIdpLdap", args, LookupOrgIdpLdapResultOutput{}, options).(LookupOrgIdpLdapResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o LookupOrgIdpLdapResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOrgIdpLdapResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
...
// Root CA for self-signed certificates for TLS connections to LDAP servers. It is intended to be filled with the contents of a .pem file.
func (o LookupOrgIdpLdapResultOutput) RootCa() pulumi.StringOutput {
	return o.ApplyT(func(v LookupOrgIdpLdapResult) string { return v.RootCa }).(pulumi.StringOutput)
}
