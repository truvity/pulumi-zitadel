...
//			_, err := zitadel.GetIdpGithubEs(ctx, &zitadel.LookupIdpGithubEsArgs{
...
func LookupIdpGithubEsOutput(ctx *pulumi.Context, args LookupIdpGithubEsOutputArgs, opts ...pulumi.InvokeOption) LookupIdpGithubEsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupIdpGithubEsResultOutput, error) {
			args := v.(LookupIdpGithubEsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zitadel:index/getIdpGithubEs:getIdpGithubEs", args, LookupIdpGithubEsResultOutput{}, options).(LookupIdpGithubEsResultOutput), nil
...
// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
func (o LookupIdpGithubEsResultOutput) AutoLinking() pulumi.StringOutput {
	return o.ApplyT(func(v LookupIdpGithubEsResult) string { return v.AutoLinking }).(pulumi.StringOutput)
}
